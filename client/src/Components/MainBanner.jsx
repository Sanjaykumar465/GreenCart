  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        px-4 md:pl-18 lg:pl-24 text-center md:text-left"
      >
        <h1
        ...
        <div className="flex items-center mt-6 font-medium">
          <Link
            to={"/products"}
            className="group flex items-center gap-2 px-7 md:px-7 py-3 bg-primary
            hover:bg-primary-dull transition rounded text-white cursor-pointer"
          >
            Shop now{" "}
            <img
              className="block md:hidden transition group-focus:translate-x-1"
